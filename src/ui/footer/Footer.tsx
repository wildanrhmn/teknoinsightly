      ...
      <div className="container mx-auto py-[55px]">
        <div className="flex flex-col gap-5 sm:gap-0 sm:flex-row justify-around">
          ...
          <div className="flex flex-col gap-1 sm:gap-5 text-primary items-center sm:items-start">
            ...
            <div className="flex flex-col gap-3 sm:gap-5 text-[14px] items-center sm:items-start">
              <Link
                href="/article/graphic-cards"
                className="hover:underline hover:text-secondary"
              >
                Graphics Cards
              </Link>
              <Link
                href="/article/processors"
                className="hover:underline hover:text-secondary"
              >
                Processors
              </Link>
              <Link
                href="/article/motherboards"
                className="hover:underline hover:text-secondary"
              >
                Motherboards
              </Link>
              <Link
                href="/article/storages"
                className="hover:underline hover:text-secondary"
              >
                Storage
              </Link>
              ...
              <Link
                href="/article/power-supplies"
                className="hover:underline hover:text-secondary"
              >
                Power Supply
              </Link>
              <Link
                href="/article/coolings"
                className="hover:underline hover:text-secondary"
              >
                Cooling
              </Link>
              <Link
                href="/article/accessories"
                className="hover:underline hover:text-secondary"
              >
                Accessories
              </Link>
