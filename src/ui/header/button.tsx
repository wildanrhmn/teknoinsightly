...
export default function SearchButton() {
  ...
  return (
    <div className="relative" ref={divRef}>
      <button onClick={() => setIsOpened(!isOpened)} className="w-[133px] h-[45px] bg-secondary text-primary flex justify-center items-center rounded-[16px] text-[15px] gap-1 hover:bg-[#218BB5] transition-colors duration-200">
        Cari
